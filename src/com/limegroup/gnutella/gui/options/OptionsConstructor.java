...
public final class OptionsConstructor {
    ...
    public static final String SAVE_KEY = "OPTIONS_SAVE_MAIN_TITLE";
    public static final String SAVE_BASIC_KEY = "OPTIONS_SAVE_BASIC_MAIN_TITLE";
    public static final String SAVE_ADVANCED_KEY = "OPTIONS_SAVE_ADVANCED_MAIN_TITLE";
    public static final String SHARED_KEY = "OPTIONS_SHARED_MAIN_TITLE";
    public static final String SHARED_BASIC_KEY = "OPTIONS_SHARED_BASIC_TITLE";
    public static final String SHARED_ADVANCED_KEY = "OPTIONS_SHARED_ADVANCED_MAIN_TITLE";
    public static final String SHARED_TYPES_KEY = "OPTIONS_SHARED_TYPES_MAIN_TITLE";
    public static final String SPEED_KEY = "OPTIONS_SPEED_MAIN_TITLE";
    public static final String DOWNLOAD_KEY = "OPTIONS_DOWNLOAD_MAIN_TITLE";
    public static final String UPLOAD_KEY = "OPTIONS_UPLOAD_MAIN_TITLE";
    public static final String UPLOAD_BASIC_KEY = "OPTIONS_UPLOAD_BASIC_MAIN_TITLE";
    public static final String UPLOAD_SLOTS_KEY = "OPTIONS_UPLOAD_SLOTS_MAIN_TITLE";
    public static final String CONNECTIONS_KEY = "OPTIONS_CONNECTIONS_MAIN_TITLE";
    public static final String BITTORRENT_KEY = "OPTIONS_BITTORRENT_MAIN_TITLE";
    ...
    public static final String SHUTDOWN_KEY = "OPTIONS_SHUTDOWN_MAIN_TITLE";
    public static final String UPDATE_KEY = "OPTIONS_UPDATE_MAIN_TITLE";
    public static final String CHAT_KEY = "OPTIONS_CHAT_MAIN_TITLE";
    public static final String LIBRARY_KEY = "OPTIONS_LIBRARY_MAIN_TITLE";
    public static final String PLAYER_KEY = "OPTIONS_PLAYER_MAIN_TITLE";
    public static final String STATUS_BAR_KEY = "OPTIONS_STATUS_BAR_MAIN_TITLE";
    public static final String ITUNES_KEY = "OPTIONS_ITUNES_MAIN_TITLE";
    public static final String ITUNES_IMPORT_KEY = "OPTIONS_ITUNES_PREFERENCE_MAIN_TITLE";
    public static final String ITUNES_DAAP_KEY = "OPTIONS_ITUNES_DAAP_MAIN_TITLE";
    public static final String POPUPS_KEY = "OPTIONS_POPUPS_MAIN_TITLE";
    public static final String BUGS_KEY = "OPTIONS_BUGS_MAIN_TITLE";
    public static final String APPS_KEY = "OPTIONS_APPS_MAIN_TITLE";
    public static final String SEARCH_KEY = "OPTIONS_SEARCH_MAIN_TITLE";
    public static final String SEARCH_LIMIT_KEY = "OPTIONS_SEARCH_LIMIT_MAIN_TITLE";
    public static final String SEARCH_QUALITY_KEY = "OPTIONS_SEARCH_QUALITY_MAIN_TITLE";
    public static final String SEARCH_SPEED_KEY = "OPTIONS_SEARCH_SPEED_MAIN_TITLE";
    public static final String CONTENT_FILTER_KEY = "OPTIONS_CONTENT_FILTER_MAIN_TITLE";
    public static final String SEARCH_JUNK_KEY = "OPTIONS_SEARCH_JUNK_MAIN_TITLE";
    public static final String FILTERS_KEY = "OPTIONS_FILTERS_MAIN_TITLE";
    public static final String RESULTS_KEY = "OPTIONS_RESULTS_MAIN_TITLE";
    public static final String MESSAGES_KEY = "OPTIONS_MESSAGES_MAIN_TITLE";
    public static final String ADVANCED_KEY = "OPTIONS_ADVANCED_MAIN_TITLE";
    public static final String PREFERENCING_KEY = "OPTIONS_PREFERENCING_MAIN_TITLE";
    public static final String FIREWALL_KEY = "OPTIONS_FIREWALL_MAIN_TITLE";
    public static final String GUI_KEY = "OPTIONS_GUI_MAIN_TITLE";
    public static final String AUTOCOMPLETE_KEY = "OPTIONS_AUTOCOMPLETE_MAIN_TITLE";
    public static final String STARTUP_KEY = "OPTIONS_STARTUP_MAIN_TITLE";
    public static final String UXSTATS_KEY = "OPTIONS_UXSTATS_MAIN_TITLE";
    public static final String PROXY_KEY = "OPTIONS_PROXY_MAIN_TITLE";
    public static final String NETWORK_INTERFACE_KEY = "OPTIONS_NETWORK_INTERFACE_MAIN_TITLE";
    public static final String ASSOCIATIONS_KEY = "OPTIONS_ASSOCIATIONS_MAIN_TITLE";
    public static final String PERFORMANCE_KEY = "OPTIONS_PERFORMANCE_MAIN_TITLE";
    public static final String STORE_KEY = "OPTIONS_STORE_MAIN_TITLE";
    public static final String STORE_BASIC_KEY = "OPTIONS_STORE_BASIC_MAIN_TITLE";
    public static final String STORE_ADVANCED_KEY = "OPTIONS_STORE_ADVANCED_MAIN_TITLE";
